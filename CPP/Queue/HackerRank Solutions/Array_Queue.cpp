...
template <typename T>
void getdata(IArrayBased<T> &arrayQueue, const std::string &input)
{
...
int main()
{
    ...
    try
    {
        ...
        {
            std::cout << (arrayQueue.isEmpty() ? "True" : "False") << std::endl;
        }
        else if (operation == "size")
        {
            std::cout << arrayQueue.size() << std::endl;
        }
        else
        {
            std::cout << "Error" << std::endl;
